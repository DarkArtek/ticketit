...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            @endif
            <div class="card">
                <div class="card-header">Aggiungi Ticket</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tickets.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="author_name" class="col-md-4 col-form-label text-md-right">Il tuo Nome</label>
                        ...
                        <div class="form-group row">
                            <label for="author_email" class="col-md-4 col-form-label text-md-right">La tua Email</label>
...
@endif
     ...
     error: function (file, response) {
         if ($.type(response) === 'string') {
             var message = response //dropzone sends en's own error messages in string
         } else {
